...
async function initMap() {
  ...
  const AMapLoader = (loader as any).default || loader
  const key = (import.meta as any).env?.VITE_AMAP_KEY || '7d4a055be06156d670e91a46c9117ef1'
  try {
    AMap = await (AMapLoader as any).load({ key, version: '2.0' })
