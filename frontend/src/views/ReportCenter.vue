...
<template>
  <div class="report-center">
    ...
    <!-- 步骤 1: 选报告类型 -->
    <div v-if="step === 'select'" class="rc-step-content is-select">
    ...
    <!-- 步骤 2: 配参数 -->
    <div v-else-if="step === 'params'" class="rc-step-content is-params">
      ...
      <div class="rc-params">
        ...
        <div class="rc-param-item">
          <el-alert type="info" :closable="false" show-icon>
            ...
            <div style="margin-top: 4px; font-size: 12px; color: var(--app-text-secondary)">
    ...
    <!-- 步骤 3: 预览 + 导出 -->
    <div v-else-if="step === 'preview' && report" class="rc-step-content is-preview">
...
.report-center {
  ...
  overflow-y: auto;
  background:
    radial-gradient(circle at 12% 0%, color-mix(in srgb, var(--app-accent) 9%, transparent), transparent 32%),
    var(--app-bg);
...
.rc-steps {
  ...
  border-radius: 12px;
  box-shadow: 0 8px 24px color-mix(in srgb, #172033 8%, transparent);
...
.rc-step-content.is-select {
  padding: 4px 0 0;
}

.rc-step-content.is-params {
  max-width: 860px;
  padding: 24px 28px;
  background: var(--app-surface-raised);
  border: 1px solid var(--app-border);
  box-shadow: 0 12px 34px color-mix(in srgb, #172033 9%, transparent);
}

.rc-step-content.is-preview {
...
.rc-type-card {
  position: relative;
  min-height: 180px;
  background: linear-gradient(145deg, var(--app-surface-raised), var(--app-surface-soft));
  border: 1px solid var(--app-border);
...
.rc-type-card:hover {
  ...
  box-shadow: 0 14px 30px color-mix(in srgb, var(--app-accent) 14%, transparent);
...
.rc-preview-toolbar {
  ...
  border-radius: 10px;
  box-shadow: 0 8px 22px color-mix(in srgb, #172033 10%, transparent);
...
@media (max-width: 900px) {
  .report-center { padding: 14px 14px 28px; }
  .rc-step-line { width: 48px; margin: 0 8px; }
  .rc-step-content.is-params { padding: 22px; }
  .rc-preview-toolbar { flex-wrap: wrap; }
  .rc-preview-tip { width: 100%; margin-left: 0; }
  .report-paper { padding: 40px 36px; }
}

@media (max-width: 600px) {
  .rc-steps { padding: 12px; }
  .rc-step-text { display: none; }
  .rc-step-line { width: 36px; }
  .rc-types { grid-template-columns: 1fr; }
  .rc-param-item { flex-direction: column; gap: 8px; }
  .rc-param-item > label { width: auto; padding-top: 0; }
  .rc-param-item > .el-radio-group,
  .rc-param-item > .el-select { width: 100%; }
  .report-paper { padding: 30px 20px; }
}
</style>
