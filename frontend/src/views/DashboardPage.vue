 ...
 *
 * 整合两个数据源：
 *  - C:\Users\15901\Desktop\shuju  →  public/data/  （GIS 导出：管线/调压箱/引入口/接头）
 *  - C:\Users\15901\Downloads\检测数据\检测数据  →  public/data/topology/  （物探数据：管径/材质/压力/建设年代/权属）
 *
 * 4 个模块（tab 切换）：
 *  - 概览  综合 KPI + 4 个图表
 *  - 管网  管线/设施 + 物探 6 维度
...
const communities = ['全部', '南海家园七里', '南海家园三里', '南海家园六里']
